...
class BiGramLanguageModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.token_embedding_table      = nn.Embedding(vocab_size,n_emd,device=device)
        self.position_embedding_table   = nn.Embedding(block_size,n_emd,device=device)
        self.lm_head                    = nn.Linear(n_emd,vocab_size,device=device)       
